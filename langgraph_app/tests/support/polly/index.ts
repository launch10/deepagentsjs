...
class PollyManager {
    ...
    public static setRecordingName(nodeName: string): void {
        ...
        // Remove existing routes for AI hosts only
        // This preserves test-specific configuration for other routes
        // if ((server as any)._routes) {
        //     (server as any)._routes = (server as any)._routes.filter((route: any) => {
