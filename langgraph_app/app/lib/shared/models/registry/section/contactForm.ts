...
export const contactFormSchema = baseSectionSchema.extend({
    headline: z.string().optional().describe("The headline for the contact form section (e.g., 'Get in Touch')."),
    introText: z.string().optional().describe("Optional introductory text above the form."),
    ...
    privacyPolicyLinkText: z.string().optional().describe("Optional text for a link to the privacy policy."),
    alternativeContactInfo: z.string().optional().describe("Alternative contact details displayed near the form (e.g., email, phone number).")
});
