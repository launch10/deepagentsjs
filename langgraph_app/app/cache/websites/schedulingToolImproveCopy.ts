...
// Helper to create Hero.tsx with custom copy
function createHeroWithCopy(
  headline: string,
  subheadline: string,
  buttonText: string,
  footerNote: string
 ...
 * Formal language, business-focused messaging.
 */
export function getSchedulingToolProfessionalFiles(): Website.FileMap {
  return {
    ...getSchedulingToolFiles(),
    "/src/components/Hero.tsx": createHeroWithCopy(
      "Enterprise-Grade Scheduling Infrastructure for Global Teams",
      "Streamline cross-timezone coordination with our intelligent scheduling platform. Trusted by 10,000+ distributed organizations worldwide.",
      "Request Demo",
      "SOC 2 compliant. Enterprise-ready. No credit card required."
    ),
  };
}
 ...
 */
export function getSchedulingToolFriendlyFiles(): Website.FileMap {
  return {
    ...getSchedulingToolFiles(),
    "/src/components/Hero.tsx": createHeroWithCopy(
      "Say Goodbye to Scheduling Chaos! 👋",
      "We get it—coordinating across time zones is a nightmare. That's why we made it ridiculously easy. You share a link, they pick a time, everyone's happy!",
      "Let's Do This!",
      "Totally free to start. No sneaky charges. Pinky promise."
    ),
  };
}
 ...
 */
export function getSchedulingToolShorterFiles(): Website.FileMap {
  return {
    ...getSchedulingToolFiles(),
    "/src/components/Hero.tsx": createHeroWithCopy(
      "Schedule Smarter. Meet Better.",
      "One link. Any timezone. Zero hassle.",
      "Start Free",
