...
export const prepareRefreshNode = NodeMiddleware.use(
  {},
  async (state: AdsGraphState, config?: any) => {
    ...
    for (const refreshItem of state.refresh) {
      const assetKey = refreshItem.asset;
