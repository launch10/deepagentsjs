...
export const heroSchema = baseSectionSchema.extend({
    ...
    ctaText: z.string().nullable().describe("Text for the call-to-action button."),
    visualConcept: z.string().nullable().describe("Description of the desired primary visual (image/video)."),
    ...
    trustSignals: z.array(z.string()).nullable().describe("List of trust signals (e.g., 'As seen on Forbes', '5-star rating')."),
});
