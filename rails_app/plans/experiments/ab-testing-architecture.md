...
A founder says: _"I'm building a scheduling tool. I think it could work for hair salons and also for personal trainers."_
...
export function useVariantContent<T>(content: Record<string, T>, defaultKey = "control"): T {
