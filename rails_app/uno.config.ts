...
type IconCollection = Record<string, Record<string, () => Promise<string>>>;

const customIconCollection = iconPaths.reduce<IconCollection>(
  (acc: IconCollection, iconPath: string) => {
