module CampaignConcerns
  module Stages
    ...
    def advance_stage!
      case stage.to_s
      when 'content'
        if valid_for_content_stage?
          update!(stage: 'highlights')
        else
          raise ActiveRecord::RecordInvalid.new(self)
        end
      when 'highlights'
        if valid_for_highlights_stage?
          update!(stage: 'plan')
        else
          raise ActiveRecord::RecordInvalid.new(self)
        end
      when 'plan'
        if valid_for_plan_stage?
          update!(stage: 'ready')
        else
          raise ActiveRecord::RecordInvalid.new(self)
        end
  ...
  def valid_for_highlights_stage?
    errors.clear
  ...
  def valid_for_launch?
    ...
    valid_for_content_stage?
    valid_for_highlights_stage?
    valid_for_plan_stage?
