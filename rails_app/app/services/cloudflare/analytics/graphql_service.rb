...
# Sample query structure for reference:
# 
# query = <<~GRAPHQL
...
#   endTime: Time.current.iso8601
# }
#
# service = Cloudflare::Analytics::GraphqlService.new
# response = service.execute(query, variables)