...
export default class extends Controller {
  ...
  syncCountToNative() {
    if (this.hasNativeBadgeTarget) {
      this.nativeBadgeTarget.setAttribute(
        "data-bridge--notification-badge-total-value",
        this.totalUnreadValue
      );
      this.nativeBadgeTarget.setAttribute(
        "data-bridge--notification-badge-account-value",
        this.accountUnreadValue
      );
    }
  }
}
