...
type NewBrainstormProps = InertiaProps.paths['/projects/new']['get']['responses']['200']['content']['application/json'];
type UpdateBrainstormProps = InertiaProps.paths['/projects/{uuid}/brainstorm']['get']['responses']['200']['content']['application/json'];
