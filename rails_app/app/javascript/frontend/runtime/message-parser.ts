...
// // Keep original tag constants for compatibility and readability
// const CODE_OPEN_TAG = '<gen-code';
// const CODE_CLOSE_TAG = '</gen-code>';
// const WRITE_OPEN_TAG = '<gen-write';
// const WRITE_CLOSE_TAG = '</gen-write>';
// const DELETE_OPEN_TAG = '<gen-delete';
// const DELETE_CLOSE_TAG = '</gen-delete>';
// const DEPENDENCY_OPEN_TAG = '<gen-add-dependency';
// const DEPENDENCY_CLOSE_TAG = '</gen-add-dependency>';
// const RENAME_OPEN_TAG = '<gen-rename';
// const RENAME_CLOSE_TAG = '</gen-rename>';
// const TEMPLATE_OPEN_TAG = '<gen-template';
// const TEMPLATE_CLOSE_TAG = '</gen-template>';
...
//   #parseNext(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
//     if (state.insideCode) {
...
//   #handleTagClose(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
...
//   #handleInsideCode(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
//     if (state.currentTag) {
...
//   #handleOutsideCode(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
...
//   #handlePotentialCodeOpen(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
//     let j = position;
...
//   #handleCodeOpen(state: MessageState, input: string, position: number, j: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
...
//   #handlePotentialTagOpen(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
...
//   #handleCodeClose(state: MessageState, input: string, position: number, messageId: string): { output: string; nextPosition: number; shouldBreak: boolean } {
//     state.insideCode = false;
//     state.currentTag = '';
//     state.potentialTag = '';
//     this._options.callbacks?.onCodeClose?.({ messageId, artifactId: state.artifactId, type: 'code' });
//     return { output: '', nextPosition: position + 1, shouldBreak: false };
//   }
