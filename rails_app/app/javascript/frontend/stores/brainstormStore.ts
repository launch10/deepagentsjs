...
type NewBrainstormInertiaProps = InertiaProps.paths['/projects/new']['get']['responses']['200']['content']['application/json'];
type UpdateBrainstormInertiaProps = InertiaProps.paths['/projects/{uuid}/brainstorm']['get']['responses']['200']['content']['application/json'];
