...
export type GetThemesResponse = NonNullable<paths["/api/v1/themes"]["get"]["responses"][200]["content"]["application/json"]>;
export type CreateThemeRequest = NonNullable<paths["/api/v1/themes"]["post"]["requestBody"]>["content"]["application/json"];
export type CreateThemeResponse = NonNullable<paths["/api/v1/themes"]["post"]["responses"][200]["content"]["application/json"]>;
...
export class ThemeService extends RailsAPIBase {
    ...
    async create(options: CreateThemeRequest): Promise<CreateThemeResponse> {
        const response = await this.client.POST("/api/v1/themes", options);
