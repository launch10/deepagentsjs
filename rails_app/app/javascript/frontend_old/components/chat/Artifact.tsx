            ...
            >
              <div className="flex items-start gap-1.5 text-sm">
                <div className="flex items-center gap-2 self-stretch">
                  <div
                    className={classNames("text-lg flex items-center", getIconColor(action.status))}
                  >
                    {status === "running" ? (
                  ...
                  <span className="text-md text-black leading-none">
                    {action.title || JSON.stringify(action)}
                  </span>
                </div>
                {type === "file" ? (
                  <div>
