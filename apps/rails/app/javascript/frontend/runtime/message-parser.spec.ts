...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <', 'Foo bar '],
      ['Foo bar <p', 'Foo bar <p'],
      [['Foo bar <', 'Foo bar <s', 'Foo bar <sp', 'Foo bar <span>some text</span>'], 'Foo bar <span>some text</span>'],
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      [
        ...
        {
          output: 'Before  After',
          callbacks: { onCodeOpen: 1, onCodeClose: 1, onWriteOpen: 0, onWriteClose: 1, onDependencyOpen: 0, onDependencyClose: 1 },
          expectedCallbackData: {
            onWriteClose: [
              expect.objectContaining({
                messageId: 'message_1',
