...
export interface paths {
    ...
    "/api/v1/websites/{website_id}/domain_context": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Returns domain context for subdomain picker */
        get: {
            parameters: {
                query?: never;
                header: {
            ...
            requestBody?: never;
            responses: {
                /** @description scopes domains to user's account only */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description returns not found when website belongs to different account */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/projects/{uuid}/restore": {
        ...
        patch: {
            ...
            requestBody?: never;
            responses: {
                /** @description successfully restores the project */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description cannot restore another account's project */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/api/v1/website_deploys/{id}/rollback": {
        ...
        get?: never;
        put?: never;
        /** Rolls back to a previous website deploy */
        post: {
            parameters: {
                query?: never;
                header: {
            ...
            requestBody?: never;
            responses: {
                /** @description successfully triggers rollback */
                200: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description returns not found for non-existent deploy */
                404: {
                    headers: {
                        [name: string]: unknown;
                    };
                ...
                /** @description cannot rollback a non-completed deploy */
                422: {
                    headers: {
                        [name: string]: unknown;
                    };
